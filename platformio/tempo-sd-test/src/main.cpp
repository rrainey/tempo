...
/*
 * This represents the SPI1 interface on the Tempo board.  It is dedicated to the SD Card peripheral.
 *
...
SPIClass spiflash(&PERIPH_SPI1, SDCARD_MISO_PIN, SDCARD_SCK_PIN, SDCARD_MOSI_PIN, PAD_SPI1_TX, PAD_SPI1_RX);
