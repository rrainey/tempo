...
class Window(QtWidgets.QMainWindow):
    ...
    def advance(self):
        ...
        if not self.is_paused:
            ...
            while self.current_index < len(self.data):
                ...
                if record[0] == "GPGGA" or record[0] == "GPGGA":
                    if (len(record[9]) > 0):
    ...
    def read_data(self):
        ...
        b = f"\nGnd track (deg,T): {lastGroundTrack_degT:.0f}\nGnd speed (mph): {lastGroundSpeed_mph:.1f}"
        self.opengl_widget.set_text(a + b)
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename='pose3.log', level=logging.INFO)
